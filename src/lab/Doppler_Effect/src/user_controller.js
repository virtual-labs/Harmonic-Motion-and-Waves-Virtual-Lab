    ...
    */
	function UserController( $mdSidenav, $mdBottomSheet, $log, $q, $scope, $element, Fullscreen, $mdToast, $animate) {
	 $scope.divshow = false; /** It hides the 'side navigate' tab */
		...
		$scope.setSourceVelocity = function() {
			setSourceVelocityFn($scope); /** Function defined in view.js file */
        };
		
		$scope.setDetectorVelocity = function() {
			setDetectorVelocityFn($scope); /** Function defined in view.js file */
        };
		
		$scope.setSourceFrequency = function() {
			setSourceFrequencyFn($scope); /** Function defined in view.js file */
        };
		
		$scope.setsourceDirection = function() {
			setsourceDirectionFn($scope); /** Function defined in view.js file */
        };
		
		$scope.setReceiverDirection = function() {
			setReceiverDirectionFn($scope); /** Function defined in view.js file */
        };
